...
internal static class LewdKeys
{
    ...
    public const string SceneEnd = "scene_end";
    ...
    /// <summary>Campaign SystemOptions key declared via plugin.json campaignOptions.</summary>
    public const string IntimacyToneOption = "intimacyTone";
    public const string ToneConsensual = "consensual";
    public const string ToneFade = "fade";
    public const string ToneGrimdark = "grimdark";

    public const string TraitSexualHistory = "sexual_history";
    public const string TraitRecoveryDie = "recovery_die";
    public const string TraitImplementProficiencies = "implement_proficiencies";
    public const string AnatomyPrefix = "anatomy.";
}
